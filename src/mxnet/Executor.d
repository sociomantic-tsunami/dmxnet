...
public class Executor (T)
{
    ...
    ***************************************************************************/
    ...
    /***************************************************************************
        ...
        Returns the outputs generated by the last forward pass of this executor

        Params:
            outputs = array to store the outputs whose elements will be
                      overwritten; the length of outputs must match the number
                      of the calculated outputs and each element must be
                      non-null

        Returns:
            the outputs generated by the last forward pass

        Throws:
            `MXNetException` if `outputs.length` is equal not to the number of
            computed outputs, or if any element of `outputs` is null
